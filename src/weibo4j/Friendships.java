...
public class Friendships extends Weibo {
	...
	public UserWapper getFriendsByID(String id, Paging page)
			throws WeiboException {
		return User.constructWapperUsers(client.get(
				WeiboConfig.getValue("baseURL") + "friendships/friends.json",
	 ...
	 * @since JDK 1.5
	 */
	public UserWapper getFollowersById(String uid, Integer count, Long cursor)
			throws WeiboException {
		return User.constructWapperUsers(client.get(
				WeiboConfig.getValue("baseURL") + "friendships/followers.json",
				new PostParameter[] { new PostParameter("uid", uid),
	...
	public UserWapper getFriendsChainFollowers(String uid, Paging page)
			throws WeiboException {
		return User.constructWapperUsers(client.get(
				WeiboConfig.getValue("baseURL")
						+ "friendships/friends_chain/followers.json",
	...
	public JSONObject getFriendsRelationship(String source_id, String target_id)
			throws WeiboException {
		return client.get(
